...
/* calculate the dimensions and where a piece's shape actually is located in the matrix. */
static void gal_shape_update_dimensions(ShapeData_t *p_shape);

/* where a piece's shape actually is located in the matrix. */
...
/* ensure, a piece stays in the map. */
...
/* calculate the value of the next direction. */
...
/* calculate the key data of a shape. */
static void gal_shape_update_dimensions(ShapeData_t *p_shape)
{
