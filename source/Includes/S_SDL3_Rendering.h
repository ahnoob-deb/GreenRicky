...
void sdla_render_texture_mod(MyGameTexture_t *p_tex, float p_x, float p_y, unsigned int p_col);
...
void sdla_draw_block_abs(size_t p_x, size_t p_y,
                         size_t p_pm_x, size_t p_pm_y,
                         int p_color);
void sdla_draw_free(double p_x, double p_y, unsigned int p_color);
void sdla_printf(const int p_x, const int p_y,
                 const int p_color, const char *p_message, ...);

void sdla_printf_tex(const int p_x, const int p_y, unsigned int p_col,
                     const char *p_message, ...);

void sdla_render_rect_from_tex(MyGameTexture_t *p_tex, float p_sx1, float p_sy1, float p_sx2, float p_sy2,
                               float p_dx1, float p_dy1, float p_dx2, float p_dy2);
