...
#define FILE_MMENU_SCREEN_MASK_OFF "../data/pics/masks/GreenRicky-mmenu-beta01.png"
#define HOOK_MMENU_SCREEN_MASK_OFF "HOOK_MM_SCR_MSK_OFF_TEX01"
#define FILE_MMENU_SCREEN_MASK_ON "../data/pics/masks/GreenRicky-mmenu-beta01.png"
#define HOOK_MMENU_SCREEN_MASK_ON "HOOK_MM_SCR_MSK_ON_TEX01"

/* INGAME TEXTURE-FILES AND HOOK-IDs */
#define FILE_INGAME_SCREEN_MASK "../data/pics/masks/GreenRicky-ingame-beta01.png"
#define HOOK_INGAME_SCREEN_MASK "HOOK_CG_SCR_MSK_BG_TEX01"
#define FILE_CELL_BLOCK_MASK "../data/pics/blocks/GreenRicky-block35x35.png"
#define HOOK_CELL_BLOCK_MASK "HOOK_CG_CELL_BLOCK_TEX01"
#define FILE_CELL_FREE_MASK "../data/pics/blocks/GreenRicky-free-block35x35.png"
#define HOOK_CELL_FREE_MASK "HOOK_CG_CELL_FREE_TEX01"

#define FILE_CELL_BLOCK_MASK_ALPHA "../data/pics/blocks/GreenRicky-block35x35.png"
#define HOOK_CELL_BLOCK_MASK_ALPHA "HOOK_CG_CELL_BLOCK_ALPHA_100_TEX01"

/* HALL OF FAME TEXTURE-FILES AND HOOK-IDs */
#define FILE_HOF_SCREEN_MASK "../data/pics/masks/GreenRicky-hof-beta01.png"
